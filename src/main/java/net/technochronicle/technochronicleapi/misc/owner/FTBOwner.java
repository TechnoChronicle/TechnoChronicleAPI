package net.technochronicle.technochronicleapi.misc.owner;
...
public non-sealed class FTBOwner extends MachineOwner {
    ...
    private static final Component displayName = Component.translatable("technochronicleapi.ownership.name.ftb");
    ...
    public String getName() {
        ...
        return team != null ? team.getName().getString() :
                Component.translatable("technochronicleapi.tooltip.status.trinary.unknown").getString();
    }
